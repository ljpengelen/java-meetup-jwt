...
The other is stored in the session (in case of the session-based back end) or the JWT (in case of the JWT-based back end) and is only accessible for the back end.
